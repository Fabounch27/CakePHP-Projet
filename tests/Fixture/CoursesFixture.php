...
class CoursesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'teacher_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'course_date' => '2020-11-20 16:59:28',
                'teacher_id' => 1,
                'created' => '2020-11-20 16:59:28',
                'modified' => '2020-11-20 16:59:28',
            ],
        ];
        parent::init();
    }
