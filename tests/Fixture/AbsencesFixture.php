...
class AbsencesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'absence_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'course_id' => 1,
                'student_id' => 1,
                'absence_date' => '2020-11-20',
                'created' => '2020-11-20 16:53:44',
                'modified' => '2020-11-20 16:53:44',
            ],
        ];
        parent::init();
    }
